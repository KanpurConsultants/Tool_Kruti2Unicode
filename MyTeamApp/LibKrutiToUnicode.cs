...
namespace MyTeamApp
{
    class LibKrutiToUnicode
    {



        static string modified_substring;
        static int array_one_length;

        static string[] array_one ={//"kZsa", 
                          // "(",")", 
                            "ñ", "Q+Z", "sas", "aa", ")Z", "ZZ", "‘", "’", "“", "”",
        ...
        public static string convert_Kritidev10_to_Unicode(string KrutiText)
        {
            string UnicodeText = "";
            array_one_length = array_one.Length;

            modified_substring = KrutiText;

            //****************************************************************************************
            //  Break the long text into small bunches of max. max_text_size  characters each.
            //****************************************************************************************
            var text_size = KrutiText.Length;
            ...
            while (chale_chalo == 1)
            {
                ...
                if (sthiti2 < (text_size - max_text_size))
                {
                    ...
                    while (KrutiText[sthiti2] != ' ') { sthiti2--; }
                }
                else { sthiti2 = text_size; chale_chalo = 0; }

                modified_substring = KrutiText.Substring(sthiti1, sthiti2);

                Replace_Symbols1();

                processed_Unicode_text += modified_substring;

                UnicodeText = processed_Unicode_text;
            }
        ...
        static void Replace_Symbols1()
        {

            int idx;
            int probable_position_of_half_r;
            string character_to_be_replaced;
            string new_replacement_string;
            ...
            if (modified_substring != "")  // if stringto be converted is non-blank then no need of any processing.
            {
                ...
                {
                    var character_next_to_i = modified_substring[position_of_i + 1];
                    ...
                    position_of_i = modified_substring.IndexOf("f", position_of_i + 1); // search for i ahead of the current position.
                ...
                while (position_of_i != -1)  //while-02
                {
                    var character_next_to_ip2 = modified_substring[position_of_i + 2];
                    ...
                    position_of_i = modified_substring.IndexOf("fa", position_of_i + 2); // search for i ahead of the current position.
                ...
                */
                ...
                {
                    var consonent_next_to_wrong_ee = modified_substring[position_of_wrong_ee + 2];
                ...
                while (position_of_R > 0)  // while-04
                {
                    ...
                    var character_at_probable_position_of_half_r = modified_substring.Substring(probable_position_of_half_r,1);
                    ...
                    while (set_of_matras.IndexOf(character_at_probable_position_of_half_r) > 0)  // while-05
                                                                                             // some vowel maatraa or anusvaar found, move to previous character
                    {
                        probable_position_of_half_r = probable_position_of_half_r - 1;
                        character_at_probable_position_of_half_r = modified_substring.Substring(probable_position_of_half_r,1);
                    ...
                    {
                        var character_previous_to_position_of_half_r = modified_substring.Substring(previous_to_position_of_half_r,1);
                        //alert(" 8. character_previous_to_position_of_half_r = "+character_previous_to_position_of_half_r );

                        while ("्".IndexOf(character_previous_to_position_of_half_r) >0) // while-06
                                                                                              //    halant found, move to previous character
                        {
                            ...
                            character_previous_to_position_of_half_r = modified_substring.Substring(previous_to_position_of_half_r,1);
                    ...
                    character_to_be_replaced = modified_substring.Substring(probable_position_of_half_r, (position_of_R - probable_position_of_half_r));
